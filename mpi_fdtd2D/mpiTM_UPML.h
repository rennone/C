...
extern inline int getSubNx(void);
extern inline int getSubNy(void);
extern inline int getSubNpx(void);
extern inline int getSubNpy(void);
extern inline int getSubNcell(void);
